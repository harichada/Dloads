...
CREATE SCHEMA ASSAMPLE;


CREATE TABLE ASSAMPLE.ASCONTAINERMANAGEDEJB
  (INDEX INTEGER NOT NULL,
   VALUE INTEGER);

ALTER TABLE ASSAMPLE.ASCONTAINERMANAGEDEJB
  ADD CONSTRAINT PK_ASCONTAINERMANAGEDEJB PRIMARY KEY (INDEX);