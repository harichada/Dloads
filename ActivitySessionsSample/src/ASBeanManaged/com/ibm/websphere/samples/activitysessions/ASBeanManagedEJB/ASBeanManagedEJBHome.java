 ...
 */
public interface ASBeanManagedEJBHome extends javax.ejb.EJBHome 
{
	/**
	 * Creates a default instance of Session Bean: ASBeanManagedEJB
	 */
	com.ibm.websphere.samples.activitysessions.ASBeanManagedEJB.ASBeanManagedEJB create() throws javax.ejb.CreateException, java.rmi.RemoteException;
}
